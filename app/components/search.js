...
export default function Search() {
    return (
        ...
        <div className="flex-1 flex items-center p-2 h-[40px] bg-white rounded-lg">
          <FontAwesomeIcon icon={faSearch} className='text-blue-500 p-2 rounded-lg'/>
          <input type="search" placeholder="Search" className="border-none outline-none text-sm text-gray-600 py-2" />
        </div>
        {/* filter */}
